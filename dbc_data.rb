...
@desert_rabbits = {karlsberg: 'aaronkarlsberg',
                  esmaili: 'AESM',
                  vaughan: 'avaughan89',
                  field: 'angelafield',
                  oztuncer: 'BanuD',
                  ...
                  giardina: 'cgardens',
                  klos: 'eclecticklos',
                  kelley: 'danimalkelley',
                  cheng: 'gsccheng',
                  sison: 'hsison',
                  mcintyre: 'jeremymcintyre',
                  foley: 'johnwfoley',
                  luse: 'JLuse',
                  won: 'godspeedyoo',
                  tice: 'ktice74',
                  ...
                  mears: 'imears',
                  chang: 'mikeychang2',
                  page: 'senormichaelpage',
                  dharamcy: 'www-coder-in',
                  salisbury: 'resalisbury',
                  fiallo: 'Ridou',
                  vanburen: 'not in socrates',
                  idrisov: 'ruslanid',
                  chuang: 'victoriachuang',
                  santin: 'vivivf',
                  tsang: 'kaawang'
                }